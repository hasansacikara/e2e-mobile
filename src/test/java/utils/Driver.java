...
public class Driver {
    ...
    public static AppiumDriver getAppiumDriver() {
        ...
        try {
            appiumServerURL = new URL("127.0.0.1:4723/wd/hub");//http:0.0.0.0:4723/wd/hub
        ...
        if (appiumDriver == null) {
            ...
            caps.setCapability("chromedriverExecutable", "C:\\Users\\DELL\\IdeaProjects\\e2e-mobile\\driver\\chromedriver.exe");
